<template>
    <div class="card col-md-7 mx-auto" style="margin-top: 150px;">
      <div class="card-body">
        <div class="row">
            <center><h5>NOVA ENQUETE</h5></center>
            <div class="mb-3">
              <label for="formGroupExampleInput" class="form-label">Titulo enquet:</label>
              <input type="text" v-model:value="titulo_enquete" class="form-control" id="formGroupExampleInput" placeholder="Titulo da enquete" v-model.trim="$v.titulo_enquete.$model">
                <div class="alert alert-warning mb-1" v-if="!$v.titulo_enquete.required && this.enviado === true" style="margin-top:10px"><strong>*Campo obrigatório</strong></div>
            </div>
            <div class="col-6 mb-3">
              ...
              <div class="alert alert-warning mb-1" v-if="!$v.data_inicial.required && this.enviado === true" style="margin-top:10px"><strong>*Campo obrigatório</strong></div>
            </div>
            <div class="col-6 mb-3">
              ...
              <div class="alert alert-warning mb-1" v-if="!$v.data_final.required && this.enviado === true" style="margin-top:10px"><strong>*Campo obrigatório</strong></div>
            </div>
            <div class="col-6 mb-3">
              ...
              <div class="alert alert-warning mb-1" v-if="!$v.horario_inicial.required && this.enviado === true" style="margin-top:10px"><strong>*Campo obrigatório</strong></div>
            </div>
            <div class="col-6 mb-3">
              ...
              <div class="alert alert-warning mb-1" v-if="!$v.horario_final.required && this.enviado === true" style="margin-top:10px"><strong>*Campo obrigatório</strong></div>
            </div>
            <div v-for="(campo, index) in campo_texto" :key="index" v-show="index !=0">
                <div class="row mb-4">
                    <div class="col-10">
                      <input v-model:value="campo.valor" type="text" placeholder="Insira a pergunta" class="form-control">
                    </div>
                    <div class="col-2">
                      <button type="button" class="btn btn-danger" @click="remover_campo(index,1)" v-show="index != 0">
                        Remover
                      </button>
                    </div>
            ...
            <div v-for="(campo, index) in campo_radio" :key="'A'+ index" v-show="index !=0">
                <div class="row mb-4">
                    <div class="col-10 mb-3">
                      <input v-model:value="campo.valor" type="text" placeholder="Insira a pergunta" class="form-control">
                    </div>
                    <div class="col-2">
                      <button type="button" class="btn btn-danger" @click="remover_campo('A'+ index,2)" v-show="index != 0">
                        Remover
                      </button>
                    </div>
                    <div class="col-10 col-sm-6">
                      <div class="form-check">
                        <input v-model="campo_radio.valor" class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" disabled>
                        <label class="form-check-label" for="flexRadioDefault1">
                        Sim
                        </label>
                        </div>
                        <div class="form-check">
                        <input v-model="campo_radio.valor" class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked disabled>
            ...
            <div v-for="(campo, index) in campo_numerico" :key="'B'+ index" v-show="index !=0">
                <div class="row mb-4">
                    <div class="col-10">
                      <input v-model:value="campo.valor" type="text" placeholder="Insira a pergunta" class="form-control">
                    </div>
                    <div class="col-2">
                      <button type="button" class="btn btn-danger" @click="remover_campo('B'+ index,3)" v-show="index != 0">
                        Remover
                      </button>
                    </div>
                    <div class="col-12 md-3 mt-3">
                        <input v-model="campo_numerico.valor" type="number" placeholder="Resposta em valor númerico" class="form-control" disabled>
                    </div>
                </div>
            </div>
        ...
        methods:{
            adicionar_campo:function(tipo){
                if(this.quantidade_questoes < 5){
                    ...
                    if(tipo == 1){
                        this.campo_texto.push({
                            valor:"",
                            tipo:1,
                        });
                    }else if(tipo == 2){
                        this.campo_radio.push({
                            valor: "",
                            tipo:2,
                        });
                    }else{
                        this.campo_numerico.push({
                            valor: "",
                            tipo:3,
                        });
                    }
            ...
            remover_campo(index_campo,tipo) {
              if(tipo == 1){
                    this.campo_texto.splice(index_campo, 1);
                }else if(tipo == 2){
                    this.campo_radio.splice(index_campo, 1);
                }else{
                    this.campo_numerico.splice(index_campo, 1);
                }
              this.quantidade_questoes -=1;
            },
            salvar_enquete(){
                ...
                if(this.$v.$invalid == false){
                    axios.post('cadastrar_enquete',{
                        ...
                        'campo_texto':this.campo_texto,
                        'campo_radio':this.campo_radio,
                        'campo_numerico':this.campo_numerico,
                    }).then(response => {this.resposta = response.data;console.log(this.resposta)},
                        /*this.campo_texto.splice(1),
                        this.campo_radio.splice(1),
                        this.campo_numerico.splice(1),
